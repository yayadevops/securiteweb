<%@ page import="com.groupeisi.securiteweb.entities.Droit" %>
<%@ page import="java.util.List" %>
<%@ page import="com.groupeisi.securiteweb.dto.DroitDto" %><%--
            ...
            <div class="col-lg-6 m-auto ">
                ...
                <form action="/Compte" method="post" class="form p-5 form-control bg-info-light">
                    ...
                    <select name="droits" id="" class="form-control form mt-2">
                        <%
                            List<DroitDto> liste = (List<DroitDto>) request.getAttribute( "droits" );
                            for( DroitDto i : liste ){
                        %>
