<%@ page import="com.groupeisi.securiteweb.entities.Compte" %>
<%@ page import="java.util.List" %>
<%@ page import="com.groupeisi.securiteweb.dto.CompteDto" %><%--
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <table class="table-info table table-striped">
                    ...
                    <%
                        List<CompteDto> liste = (List<CompteDto>) request.getAttribute( "comptes" );
                        for( CompteDto i : liste ){
                    %>
                    <tr>
                        <td><%= i.getId() %>  </td>
                        <td><%= i.getUsername() %>  </td>
